...
import IlabMQTT.radioactivity.simulation.utilities.JSonLabExperimentInfo;
/**
 *
 * @author uqlpayne
 */
...
//
    ...
    //MQTT topic
    private String Topic_LabExperimentInfo=this.topis.iLabRadioactivitySimulationRaw+this.topis.LabExperimentInfo;
    //
    ...
    //JSon LabExperimentInfo
    JSonLabExperimentInfo JSonLabExperimentInfo;
    ...
    public LabExperimentEngine(int unitId, LabManagement labManagement) throws Exception {
	    ...
	    String clientId = "LabExperimentEngine";
...
//                    Logfile.Write(logLevel, logMessage);
                ...
                switch (thisState) {
                    case GetExperiment:
                        ...
                        /////////////output the labExperimentInfo//////
                        System.out.println("Sb Name: "+labExperimentInfo.getSbName());
                        System.out.println("User Group: "+labExperimentInfo.getUserGroup());
                        System.out.println("Experiment ID: "+labExperimentInfo.getExperimentId());
                        String SbName=labExperimentInfo.getSbName();
                        String UserGroup=labExperimentInfo.getUserGroup();
                        int ExperimentId=labExperimentInfo.getExperimentId();
                        this.JSonLabExperimentInfo=new JSonLabExperimentInfo(SbName,UserGroup,ExperimentId);
                        
                        //publish LabExperimentInfo
                        this.MQTTClient.publish(this.Topic_LabExperimentInfo, qos, JSonLabExperimentInfo.getJsonString().getBytes());
